...
// → true！攻击成功！
```
![Pasted image 20260622182233](../../../../PNG/Pasted%20image%2020260622182233.png)
> [!important]  注意一个细节
...
```
![Pasted image 20260622182810](../../../../PNG/Pasted%20image%2020260622182810.png)
# 5.修复方案对比
## 5.1 方案一：过滤危险键名
```js
...
console.log('\n修复成功！两种攻击都被拦截！');
```
![Pasted image 20260622184008](../../../../PNG/Pasted%20image%2020260622184008.png)
## 7.真实 CVE 案例：lodash.merge

> [!important]  CVE-2018-3721 / CVE-2020-8203：lodash 原型链污染
